...
public @interface Logic {
    ...
    @interface Mixin {
        ...
        @interface Parameter {
             ...
             * <p>
             * This value should be provided for types which are known at compile-time to the annotation processor.
             * <p>
             * For referencing types generating by the annotation processor, {@link Parameter#typeName()} can be used to
             * resolve the limitations of {@link Class} linkage in annotations.
             *
            ...
            /**
             * Represents the fully-qualified type name of the parameter.
             * <p>
             * This is an optional field that provides the fully-qualified type name of the parameter. If the type name
             * is non-empty, it is used instead the value of {@link Parameter#type()}.
             * <p>
             * {@link Parameter#type()} should be used where possible. As a fallback behavior to compile-time limitations
             * of referencing {@link Class} within annotations (i.e. you cannot reference classes generated by annotation
             * processors since the type in the annotations has to be resolved before the annotation processor is run).
             * <p>
             * Primitive types are <b>not supported</b> to be passed by type name. There is not a scenario where the direct
             * {@link Class} cannot be used (e.g. {@code type = int.class} can be used instead of passing
             * {@code typeName = "int"}).
             *
